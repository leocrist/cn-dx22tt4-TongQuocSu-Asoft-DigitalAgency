  ...
  return (
    <section className="px-6 md:px-12 pt-20 pb-16">
      <div className="max-w-5xl mx-auto text-center">
        <ScrollReveal>
          <h1 className="text-7xl md:text-8xl font-bold mb-12 tracking-tight animate-title-reveal">DigitalAgency</h1>
        </ScrollReveal>

        <ScrollReveal>
          <p className="text-base text-center max-w-3xl mx-auto mb-10 leading-relaxed animate-description">
            Established in 2012, Infinity Solutions stands as a premier strategic branding and design agency, dedicated
